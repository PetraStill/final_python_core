"""Модуль довідкової інформації для CLI-асистента.

Містить текст HELP_TEXT, який описує всі доступні команди,
їхній формат, приклади використання та результати виконання.
Функція help_text() повертає цей текст для виведення у CLI.
"""
...
Команди:
  ...
  phone <name>
      Приклад: phone John
      Результат: Показує всі номери телефону контакту з указаним ім'ям.
